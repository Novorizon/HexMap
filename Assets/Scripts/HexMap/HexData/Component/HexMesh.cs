...
namespace HexMap
{
    public class HexMesh : MonoBehaviour
    {
        ...
        public void Set(bool useCollider, bool useCellData, bool useUVCoordinates, bool useUV2Coordinates)
        {
            MeshFilter mf = gameObject.AddComponent<MeshFilter>();
            mf.mesh = hexMesh = new Mesh();
            if (useCollider)
                meshCollider = gameObject.AddComponent<MeshCollider>();
            this.useCollider = useCollider;
            this.useCellData = useCellData;
            this.useUVCoordinates = useUVCoordinates;
            this.useUV2Coordinates = useUV2Coordinates;
